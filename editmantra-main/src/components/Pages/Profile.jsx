      ...
      <div className="max-w-6xl mx-auto p-8 flex gap-8">
        ...
        <div className="w-1/3 bg-gradient-to-r from-indigo-500 to-purple-500 shadow-lg rounded-lg p-6 text-white relative">
          <Link to="/EditProfile" className="absolute top-4 right-4 group w-9 h-9">
            <img src="./public/EditProfile.png"alt="Profile Logo"className="object-cover w-full h-full rounded-full"/><span className="absolute left-1/2 transform -translate-x-1/2 -translate-y-full bg-blue-700 text-white rounded-md text-sm py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Edit</span>
          </Link>
