...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-r from-purple-200 to-pink-200"
      style={{ backgroundImage: 'url(./public/LogIn.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <Header />
      <div className="flex-grow flex items-center justify-center">
        <div className="relative z-10 rounded-lg p-8 w-full max-w-xl ml-auto mr-20 bg-slate-500 shadow-2xl shadow-gray-800">
          <h2 className="text-3xl font-bold text-cyan-300 text-center mb-6">SIGN UP</h2>
          <form onSubmit={handleSignup} className="space-y-3">
            ...
            <div>
              <select
                ...
                className="w-full p-4 mb-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400"
              >
            ...
            <button
              type="submit"
              className="w-full bg-cyan-300 text-white py-3 rounded-lg text-xl hover:bg-purple-400 transition duration-300 disabled:opacity-50"
              disabled={isLoading}
            >
              {isLoading ? 'Signing up...' : 'Signup'}
            </button>
          </form>
          <div className="mt-6 text-center font-semibold text-xl text-gray-100">
